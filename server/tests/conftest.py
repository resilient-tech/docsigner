"""Server test setup. The env vars must be in place before docsigner_server.app
...
# Make docsigner_server importable when pytest runs from the tests directory.
...
TMP_DIR = Path(tempfile.mkdtemp(prefix="docsigner-server-tests-"))
